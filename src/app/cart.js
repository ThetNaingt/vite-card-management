...
export const createCartUi = ({ id, image, price, title }) => {
  ...
  cart.innerHTML = `
    <div class="mb-5 group">
        ...
        alt=""
        />
        <div class="border border-neutral-400 shadow p-4 pt-10 text-neutral-700 relative">
        <button class='cart-remove-btn absolute top-4 right-4 opacity-0 translate-x-10 duration-200 group-hover:opacity-100 group-hover:translate-x-0 cart-item-decrement'>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 stroke-red-400" >
        ...
        <div class="flex justify-between">
            ...
            <div
            class="flex justify-between items-center w-[130px] bg-neutral-100"
            >
...
export const cartRemoveBtnHandler = (event) => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      currentCart.classList.add("animate__animated","animate__zoomOut")
